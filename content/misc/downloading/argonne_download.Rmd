...
> NOTE: This file will not work as-is because the URLs for data download are for one-time use.
...
## Make MD5 sum file
Annoyingly, the md5sum hashes are provided in the ANL web interface, not as a downloadable file, we have to manually construct the md5sum file by copying the md5 hash for each FASTQ from the web interface.
